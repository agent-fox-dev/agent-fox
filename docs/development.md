...
skills/                   # A note on the markdown skills the tools replaced
testdata/                 # Shared test fixtures
.specs/                   # Specs generated by, and implemented with, the tools
bin/, dist/               # Build output
install.sh                # Installs the release binaries of the four tools
```
