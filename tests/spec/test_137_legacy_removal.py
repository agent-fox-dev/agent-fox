...
_AGENT_FOX_ROOT = _REPO_ROOT / "agent_fox"
...
class TestTypesExportsFinding:
    ...
    def test_finding_constructable(self) -> None:
        from agent_fox.spec.types import SEVERITY_ERROR, Finding
    ...
    def test_compute_exit_code_empty(self) -> None:
        from agent_fox.spec.types import compute_exit_code
...
class TestNoValidatorImports:
    ...
    def test_lint_py_no_validator_imports(self) -> None:
        ...
        content = _read_source("agent_fox/spec/lint.py")
    ...
    def test_lint_specs_py_no_validator_imports(self) -> None:
        ...
        content = _read_source("agent_fox/cli/lint_specs.py")
        assert "agent_fox.spec.validators" not in content
    ...
    def test_hot_load_no_validator_imports(self) -> None:
        ...
        """
        content = _read_source("agent_fox/engine/hot_load.py")
        assert "agent_fox.spec.validators" not in content
...
class TestNoCoreSpecFilesConstant:
    ...
    def test_no_core_spec_files_in_context(self) -> None:
        content = _read_source("agent_fox/session/context.py")
...
class TestNoV1MarkdownInDiscovery:
    ...
    def test_no_v1_markdown_string(self) -> None:
        content = _read_source("agent_fox/spec/discovery.py")
