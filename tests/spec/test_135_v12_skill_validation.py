...
_SKILL_TEMPLATE_PATH = _REPO_ROOT / "agent_fox" / "_templates" / "skills" / "af-spec"
...
class TestValidationErrorMapping:
    ...
    def test_validation_error_mapped_to_finding(self) -> None:
        ...
        from agent_fox.spec.lint import _map_afspec_findings
...
class TestCliFlagsUnchanged:
    ...
    def test_cli_accepts_all_flag(self, v12_specs_root: Path) -> None:
        ...
        from agent_fox.cli.lint_specs import lint_specs_cmd
