...
from agent_fox.cli.code import _check_dry_run_conflicts
from agent_fox.engine.run import _setup_infrastructure, run_code
...
class TestDryRunNoDebugMention:
    ...
    def test_dry_run_no_debug_mention(self, cli_runner: CliRunner) -> None:
        ...
        with (
            ...
            patch("agent_fox.cli.code.discover_specs", return_value=[]),
        ):
