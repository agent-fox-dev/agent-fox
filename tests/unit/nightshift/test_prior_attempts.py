...
from agent_fox.nightshift.prior_attempts import (
    PriorAttempt,
...
class TestContextInjectedIntoPrompt:
    ...
    def test_context_injected_into_task_prompt(self) -> None:
        ...
        from agent_fox.nightshift.fix_pipeline import FixPipeline, TriageResult
...
class TestPipelineWiring:
    ...
    async def test_pipeline_wires_query_into_process_issue(self) -> None:
        ...
        with (
            patch(
                "agent_fox.nightshift.fix_pipeline.query_prior_attempts",
                create=True,
                return_value=[],
            ) as mock_query,
            patch(
                "agent_fox.nightshift.fix_pipeline.format_prior_attempts",
                create=True,
                return_value="",
            ),
