...
from agent_fox.workspace.health import HealthReport, check_workspace_health
...
class TestWorkspaceStateNoPermBlock:
    ...
    async def test_prepare_launch_dirty_skips_without_blocking(self) -> None:
        ...
        from agent_fox.engine.dispatch import DispatchManager
        ...
        with patch(
            "agent_fox.workspace.health.check_workspace_health",
