...
```bash
pip install "agentfox @ git+https://github.com/agent-fox-dev/agent-fox.git@v4.1.4#subdirectory=packages/agentfox"
pip install "afspec @ git+https://github.com/agent-fox-dev/agent-fox.git@v4.1.4#subdirectory=packages/afspec"
pip install "afaudit @ git+https://github.com/agent-fox-dev/agent-fox.git@v4.1.4#subdirectory=packages/afaudit"
```
