...
def build_task_prompt(
    ...
    return (
        ...
        f"{task_group}.\n"
        f"\n"
        f"When you finish each subtask, mark it done by running:\n"
        f"  afspec update-subtask <spec-dir> <subtask-id> done\n"
        f"where <spec-dir> is the spec directory path shown in the context "
        f"above, and <subtask-id> is the subtask ID (e.g. 1.1).\n"
        f"Never edit tasks.json directly — always use the afspec CLI.\n"
        f"\n"
