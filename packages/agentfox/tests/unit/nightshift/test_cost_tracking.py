...
class TestCliCreatesSinkDispatcher:
    ...
    def test_cli_creates_sink_dispatcher_with_duckdb(self) -> None:
        ...
        with (
            ...
            patch("agentfox.ui.display.create_theme"),
            patch("agentfox.ui.progress.ProgressDisplay") as mock_progress_cls,
            patch("agentfox.nightshift.daemon.DaemonRunner") as mock_runner_cls,
