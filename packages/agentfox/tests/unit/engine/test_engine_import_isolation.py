...
class TestNoRetrievalImports:
    ...
    def test_engine_files_clean(self) -> None:
        ...
        engine_dir = _REPO_ROOT / "agentfox" / "engine"
...
class TestNightshiftNoSleepStream:
    ...
    def test_no_sleep_compute_stream(self) -> None:
        streams_path = _REPO_ROOT / "agentfox" / "nightshift" / "streams.py"
...
class TestNoTestImportsDeleted:
    ...
    DELETED_MODULES = [
        ...
        "agentfox.knowledge.embeddings",
        "agentfox.knowledge.search",
        "agentfox.knowledge.retrieval",
        "agentfox.knowledge.causal",
        "agentfox.knowledge.lifecycle",
        "agentfox.knowledge.contradiction",
        "agentfox.knowledge.consolidation",
        "agentfox.knowledge.compaction",
        "agentfox.knowledge.entity_linker",
        "agentfox.knowledge.entity_query",
        "agentfox.knowledge.entity_store",
        "agentfox.knowledge.entities",
        "agentfox.knowledge.static_analysis",
        "agentfox.knowledge.sleep_compute",
        "agentfox.knowledge.rendering",
        "agentfox.knowledge.store",
        "agentfox.knowledge.facts",
        "agentfox.knowledge.ingest",
        "agentfox.knowledge.onboard",
        "agentfox.engine.knowledge_harvest",
    ]
