...
from agentfox.fix.checks import CheckCategory, CheckDescriptor
...
class TestFixLoopAllFixed:
    ...
    async def test_all_passing_terminates_immediately(
        ...
        with (
            patch(
                "agentfox.fix.fix.detect_checks",
...
class TestFixLoopMaxPasses:
    ...
    async def test_max_passes_terminates_with_remaining(
        ...
        with (
            ...
            patch(
                "agentfox.fix.fix.generate_fix_spec",
                return_value=mock_spec,
            ),
            patch(
                "agentfox.fix.fix.cleanup_fix_specs",
            ),
        ):
