...
from agentfox.knowledge.review_store import validate_verdict
from agentfox.session.review_parser import parse_verification_results
...
class TestValidateVerdictNormalization:
    ...
    def test_warning_logged_for_non_standard(self, caplog: Any) -> None:
        ...
        with caplog.at_level(logging.WARNING, logger="agentfox.knowledge.review_store"):
...
class TestParseVerificationResultsAuditEvent:
    ...
    def test_audit_event_is_warning_severity(self) -> None:
        ...
        from agentfox.knowledge.audit import AuditSeverity
