...
```bash
pip install "afspec @ git+https://github.com/agent-fox-dev/agent-fox.git@v4.1.16#subdirectory=packages/afspec"
```
...
[project]
dependencies = [
    "afspec @ git+https://github.com/agent-fox-dev/agent-fox.git@v4.1.16#subdirectory=packages/afspec",
]
```
