...
TS-01-34: agentfox/pyproject.toml declares afaudit>=4.1.18
...
class TestAgentfoxDependency:
    ...
    def test_afaudit_in_agentfox_dependencies(self) -> None:
        """agentfox must list afaudit>=4.1.18 in [project.dependencies]."""
        ...
        dep_str = matching[0]
        assert "4.1.18" in dep_str, f"Expected version constraint with 4.1.18, got: {dep_str}"
